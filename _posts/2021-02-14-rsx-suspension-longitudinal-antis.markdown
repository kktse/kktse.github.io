...
suspension designs from the Acura RSX are pictured below with the front
suspension MacPherson strut design on the left and the rear suspension H-arm
with camber link design on the right.
...
Safety Administration, the following values for weight distribution and
centre of gravity height are used:
