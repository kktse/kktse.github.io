...
- Continental notes that the tire operates well at high static camber, citing
  good performance and durability on an BMW M4 GT4 with static camber set
  between -3 and -4 deg.
...
Vertical load and inclination angle were controlled through the use of our
...
is trained using the footprints we collected in the previous section. Latent
...
- **Adam Mann** from [NUMMI Racing][3] supplied us with the Continental
  ...
  borrow a set to bring it into the laboratory.
